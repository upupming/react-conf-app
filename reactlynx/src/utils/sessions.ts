import type { ApiAllSessions, Session, Speaker } from "@/types.js";
// @ts-ignore
import { allTalks } from "@/utils/testData/allSessions.js";
import { isDayOneSession, isDayTwoSession } from "./formatDate.js";
